...
164	When a child lack support from his mother or is restricted and unable to explore the world he becomes more stressful.(neglect or over-concern)\n\nStress affects the development of the consolidation of memories, and thus the affect how experiences are build in the brain.	Childhood stress -> Neglect or over-concern from mother	Cassidy, Jude. "Child-Mother Attachment and the Self in Six-Year-Olds." Child Development 59.1 (1988): 121. Web. \n\n"Maternal Deprivation." Wikipedia. Wikimedia Foundation, n.d. Web. 23 Dec. 2016.
